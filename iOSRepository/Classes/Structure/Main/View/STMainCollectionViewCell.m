...
@interface STMainCollectionViewCell()
@property (nonatomic,strong) UIImageView *imageView;
@end

@implementation STMainCollectionViewCell
- (instancetype)init{
    if (self = [super init]) {
        [self setUpSubViews];
    }
...
- (void)setImage:(UIImage *)image{
    _imageView.image = [self blurryImage:image withBlurLevel:0.3];
